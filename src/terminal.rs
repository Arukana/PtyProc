...
{ let termios: termios = unsafe { ::std::mem::zeroed() };
  unsafe { libc::ioctl(fd, (0x40000000 | (116 << 8) | 19 | (((::std::mem::size_of::<termios>() & 0x1FFF) << 16) as u64)), &termios); }
  unsafe 
...
fn enter_raw_mode(fd: libc::c_int) -> Result<()> {
    ...
    unsafe { libc::ioctl(fd, (0x40000000 | (116 << 8) | 19 | (((::std::mem::size_of::<termios>() & 0x1FFF) << 16) as u64)), &new_termios); }
    new_termios.c_lflag ^= !(libc::ICANON);
    new_termios.c_lflag ^= !(libc::ECHO);
    new_termios.c_cc[libc::VMIN] = 1;
    new_termios.c_cc[libc::VTIME] = 0;
    unsafe { libc::ioctl(fd, (0x80000000 | (116 << 8) | 20 | (((::std::mem::size_of::<termios>() & 0x1FFF) << 16) as u64)), &new_termios); }
